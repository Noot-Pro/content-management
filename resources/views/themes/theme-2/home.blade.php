                ...
                <div class="lg:col-span-6 col-span-full mb-16 xl:mb-0">
                    ...
                    <div class="faqs-list" x-data="{ openIndex: null }">
                        <div class="faqs-list__item cursor-pointer p-7 rounded-[24px] xl:rounded-[32px] transition ease-in-out" :class="{ 'faqs-list__item--active': openIndex === 0 }">
                            ...
                            <div x-show="openIndex === 0" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="faq-content mt-4 text-base text-[#8C9399] font-light">{{ __('noot-pro-content-management::site.solution_1_text') }}</div>
                        </div>
                        <div class="faqs-list__item cursor-pointer p-7 rounded-[24px] xl:rounded-[32px] transition ease-in-out" :class="{ 'faqs-list__item--active': openIndex === 1 }">
                            ...
                            <div x-show="openIndex === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="faq-content mt-4 text-base text-[#8C9399] font-light">{{ __('noot-pro-content-management::site.solution_2_text') }}</div>
                        </div>
                        <div class="faqs-list__item cursor-pointer p-7 rounded-[24px] xl:rounded-[32px] transition ease-in-out" :class="{ 'faqs-list__item--active': openIndex === 2 }">
                            ...
                            <div x-show="openIndex === 2" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="faq-content mt-4 text-base text-[#8C9399] font-light">{{ __('noot-pro-content-management::site.solution_4_text') }}</div>
                        </div>
                        <div class="faqs-list__item cursor-pointer p-7 rounded-[24px] xl:rounded-[32px] transition ease-in-out" :class="{ 'faqs-list__item--active': openIndex === 3 }">
                            ...
                            <div x-show="openIndex === 3" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-2" class="faq-content mt-4 text-base text-[#8C9399] font-light">{{ __('noot-pro-content-management::site.solution_5_text') }}</div>
                        </div>
                    </div>
                </div>
