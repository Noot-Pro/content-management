<div>
    <section class="w-full bg-no-repeat bg-bottom">
        <div class="container px-4 py-20 pb-2">
            <div class="text-center">
                ...
                <div class="text-[32px] xl:text-[64px] font-bold mb-6">{{ __('noot-pro-content-management::site.home_head_1') }} <span class="block text-(--primary-color)">{{ __('noot-pro-content-management::site.home_head_2') }}</span></div>
                ...
                <div class="flex justify-center gap-x-4">
                    <a href="{{ filament()->getRegistrationUrl() }}" class="px-6 py-3.5 border-2 rounded-xl border-(--primary-color) bg-(--primary-color) hover:bg-(--secondary-color) hover:border-(--secondary-color) text-white transition ease-in-out">{{ __('noot-pro-content-management::site.start_free_test') }}</a>
    ...
    <section class="w-full">
        <div class="container px-4 pt-12 xl:pt-14 mb-2">
            <div class="text-[32px] xl:text-[48px] font-bold mb-10 xl:mb-20 text-center">{{ __('noot-pro-content-management::site.features_title') }} <span class="block text-(--primary-color)">{{ __('noot-pro-content-management::site.one_place') }}</span></div>
            <div class="grid grid-cols-12  gap-x-4">
                <div class="group lg:col-span-6 xl:col-span-8 col-span-full p-7 lg:p-14 mb-5 bg-[#F7F7F7] lg:h-[250px] rounded-[24px] xl:rounded-[48px] transition ease-in-out hover:bg-(--hover-bg-color)">
                    <div class="text-xl mb-2.5 transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.feature_title_1') }}</div>
                    <div class="text-base text-[#8C9399] font-light max-w-[524px]">{{ __('noot-pro-content-management::site.feature_text_1') }}</div>
                </div>
                <div class="group lg:col-span-6 xl:col-span-4 col-span-full p-7 lg:p-14 mb-5 bg-[#F7F7F7] lg:h-[250px] rounded-[24px] xl:rounded-[48px] transition ease-in-out hover:bg-(--hover-bg-color)">
                    <div class="text-xl mb-2.5 transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.feature_title_2') }}</div>
                    <div class="text-base text-[#8C9399] font-light max-w-[524px]">{{ __('noot-pro-content-management::site.feature_text_2') }}</div>
                </div>

                <div class="group lg:col-span-6 xl:col-span-4 col-span-full p-7 lg:p-14 mb-5 bg-[#F7F7F7] lg:h-[350px] rounded-[24px] xl:rounded-[48px] transition ease-in-out hover:bg-(--hover-bg-color)">
                    <div class="text-xl mb-2.5 transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.feature_title_3') }}</div>
                    <div class="text-base text-[#8C9399] font-light max-w-[524px]">{{ __('noot-pro-content-management::site.feature_text_3') }}</div>
                </div>

                <div class="group lg:col-span-6 xl:col-span-4 col-span-full p-7 lg:p-14 mb-5 bg-[#F7F7F7] lg:h-[350px] rounded-[24px] xl:rounded-[48px] transition ease-in-out hover:bg-(--hover-bg-color)">
                    <div class="text-xl mb-2.5 transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.feature_title_4') }}</div>
                    <div class="text-base text-[#8C9399] font-light max-w-[524px]">{{ __('noot-pro-content-management::site.feature_text_4') }}</div>
                </div>

                <div class="group lg:col-span-6 xl:col-span-4 col-span-full p-7 lg:p-14 mb-5 bg-[#F7F7F7] lg:h-[350px] rounded-[24px] xl:rounded-[48px] transition ease-in-out hover:bg-(--hover-bg-color)">
                    <div class="text-xl mb-2.5 transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.feature_title_5') }}</div>
    ...
    <section class="w-full">
        <div class="container px-4">
            <div class="text-[32px] xl:text-[48px] font-bold mb-10 xl:mb-20 text-center">{{ __('noot-pro-content-management::site.why_choose') }} <span class="text-(--primary-color)">{{ __('noot-pro-content-management::site.noot') }}</span></div>
                ...
                <div class="timeline__items ps-12 xl:ps-0">
                    ...
                    <div class="timeline__item timeline__item--first mb-16 xl:mb-32 group">
                        <div class="grid xl:grid-cols-12 lg:gap-x-12 xl:gap-x-24 min-h-[250px]">
                            <div class="hidden xl:block xl:col-span-6 col-span-full overflow-hidden h-[424px]  rounded-[48px] transition ease-in-out group-hover:bg-(--hover-bg-color)">
                            ...
                            <div class="xl:col-start-7 xl:col-span-6 col-span-full">
                                <div class="py-1.5 px-3 mb-2.5 inline-block text-sm border rounded-xl border-(--primary-color) text-(--primary-color)">{{ __('noot-pro-content-management::site.solution_badge') }}</div>
                                <div class="text-xl mb-2.5">{{ __('noot-pro-content-management::site.solution_title') }}</div>
                                <div class="text-xl text-[#8C9399] font-light transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.solution_text') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="timeline__item mb-16 xl:mb-32 group">
                        <div class="grid xl:grid-cols-12 lg:gap-x-12 xl:gap-x-24 items-center min-h-[250px] xl:min-h-[424px]">
                            <div class="lg:col-span-6 col-span-full xl:text-left">
                                <div class="py-1.5 px-3 mb-2.5 inline-block text-sm border rounded-xl border-(--primary-color) text-(--primary-color)">{{ __('noot-pro-content-management::site.easy_use_badge') }}</div>
                                <div class="text-xl mb-2.5">{{ __('noot-pro-content-management::site.easy_use_title') }}</div>
                                <div class="text-xl text-[#8C9399] font-light transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.easy_use_text') }}</div>
                            </div>
                            <div class="hidden xl:block xl:col-start-7 xl:col-span-6 col-span-full overflow-hidden h-[424px] rounded-[48px] transition ease-in-out group-hover:bg-(--hover-bg-color)">
                    ...
                    <div class="timeline__item mb-16 xl:mb-32 group">
                        <div class="grid xl:grid-cols-12 lg:gap-x-12 xl:gap-x-24 items-center min-h-[250px] xl:min-h-[424px]">
                            ...
                            <div class="xl:col-start-7 lg:col-span-6 col-span-full">
                                <div class="py-1.5 px-3 mb-2.5 inline-block text-sm border rounded-xl border-(--primary-color) text-(--primary-color)">{{ __('noot-pro-content-management::site.support_badge') }}</div>
                                <div class="text-xl mb-2.5">{{ __('noot-pro-content-management::site.support_title') }}</div>
                                <div class="text-xl text-[#8C9399] font-light transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.support_text') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="timeline__item mb-16 xl:mb-32 group">
                        <div class="grid xl:grid-cols-12 lg:gap-x-12 xl:gap-x-24 items-center min-h-[250px] xl:min-h-[424px]">
                            <div class="lg:col-span-6 col-span-full xl:text-left">
                                <div class="py-1.5 px-3 mb-2.5 inline-block text-sm border rounded-xl border-(--primary-color) text-(--primary-color)">{{ __('noot-pro-content-management::site.integration_badge') }}</div>
                                <div class="text-xl mb-2.5">{{ __('noot-pro-content-management::site.integration_title') }}</div>
                                <div class="text-xl text-[#8C9399] font-light transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.integration_text') }}</div>
                            </div>
                            <div class="hidden xl:block xl:col-start-7 xl:col-span-6 col-span-full overflow-hidden h-[424px] rounded-[48px] transition ease-in-out group-hover:bg-(--hover-bg-color)">
                    ...
                    <div class="timeline__item mb-16 xl:mb-32 group">
                        <div class="grid xl:grid-cols-12 lg:gap-x-12 xl:gap-x-24 items-center min-h-[250px] xl:min-h-[424px]">
                            ...
                            <div class="xl:col-start-7 lg:col-span-6 col-span-full">
                                <div class="py-1.5 px-3 mb-2.5 inline-block text-sm border rounded-xl border-(--primary-color) text-(--primary-color)">{{ __('noot-pro-content-management::site.analysis_badge') }}</div>
                                <div class="text-xl mb-2.5">{{ __('noot-pro-content-management::site.analysis_title') }}</div>
                                <div class="text-xl text-[#8C9399] font-light transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.analysis_text') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="timeline__item mb-16 xl:mb-32 group">
                        <div class="grid xl:grid-cols-12 lg:gap-x-12 xl:gap-x-24 items-center min-h-[250px] xl:min-h-[424px]">
                            <div class="lg:col-span-6 col-span-full xl:text-left">
                                <div class="py-1.5 px-3 mb-2.5 inline-block text-sm border rounded-xl border-(--primary-color) text-(--primary-color)">{{ __('noot-pro-content-management::site.security_badge') }}</div>
                                <div class="text-xl mb-2.5">{{ __('noot-pro-content-management::site.security_title') }}</div>
                                <div class="text-xl text-[#8C9399] font-light transition ease-in-out group-hover:text-(--primary-color)">{{ __('noot-pro-content-management::site.security_text') }}</div>
                            </div>
                            <div class="hidden xl:block xl:col-start-7 xl:col-span-6 lg:col-span-6 col-span-full overflow-hidden h-[424px] rounded-[48px] transition ease-in-out group-hover:bg-(--hover-bg-color)">
        ...
        <div class="container px-4 pt-32 xl:pt-48">
            <div class="grid xl:grid-cols-12 gap-x-24 w-full min-h-full">
                <div class="lg:col-span-6 col-span-full mb-16 xl:mb-0">
                    <div class="text-[32px] xl:text-[48px] font-bold mb-10 xl:mb-20 text-center xl:text-right">{{ __('noot-pro-content-management::site.explore_solutions') }} <span class="text-(--primary-color)">{{ __('noot-pro-content-management::site.noot_provided') }}</span></div>
                    <div x-data="{
                        activeAccordion: '',
                ...
                <div class="lg:col-span-6 col-span-full md:h-[600px] overflow-hidden bg-[#F7F7F7] rounded-[24px] xl:rounded-[48px] transition ease-in-out group-hover:bg-(--hover-bg-color)">
    ...
    <section class="w-full">
        <div class="container px-4 pt-32 xl:pt-48">
            <div class="text-[32px] xl:text-[48px] font-bold mb-10 xl:mb-20 text-center">{{ __('noot-pro-content-management::site.partners_said') }} <span class="text-(--primary-color)">{{ __('noot-pro-content-management::site.partners') }}</span></div>
    ...
    <section class="w-full" id="plans">
        <div class="container px-4 py-32 xl:py-48">
            <div class="text-[32px] xl:text-[48px] font-bold mb-10 xl:mb-20 text-center">{{ __('noot-pro-content-management::site.various_packages') }} <span class="text-(--primary-color)">{{ __('noot-pro-content-management::site.for_all_categories') }}</span></div>
            <div class="grid grid-cols-12 gap-0 lg:gap-x-8 2xl:gap-x-20 items-stretch">
                <div class="xl:col-span-4 mb-6 xl:mb-0 col-span-full p-7 xl:p-14 bg-[#F7F7F7] rounded-[24px] xl:rounded-[48px] flex flex-col justify-between hover:shadow-2xl hover:bg-(--hover-bg-color) transition ease-in-out">
                    <div class="mb-10">
                ...
                <div class="xl:col-span-4 mb-6 xl:mb-0 col-span-full p-7 xl:p-14 bg-[#F7F7F7] rounded-[24px] xl:rounded-[48px] flex flex-col justify-between hover:shadow-2xl hover:bg-(--hover-bg-color) transition ease-in-out">
                    <div class="mb-10">
                        <div class="text-2xl mb-2 flex items-center">{{ __('noot-pro-content-management::site.main_package_title') }} <span class="bg-[#FFEEE5] ms-1.5 px-3 py-1 text-(--primary-color) text-xs border rounded-[10px] border-[#FFDECC]">{{ __('noot-pro-content-management::site.main_package_badge') }}</span></div>
                        ...
                        <div class="mb-10 pb-10 border-b border-[#E8E8E8]">
                            ...
                            <div class="space-y-2 mb-4">
                                <div class="flex items-center justify-between text-base">
                                    ...
                                    <span class="text-(--primary-color) font-semibold">{{ __('noot-pro-content-management::site.discount_3_months_price') }}</span>
                                </div>
                                <div class="flex items-center justify-between text-base">
                                    <span class="text-[#585757] font-light">{{ __('noot-pro-content-management::site.discount_6_months') }}</span>
                                    <span class="text-(--primary-color) font-semibold">{{ __('noot-pro-content-management::site.discount_6_months_price') }}</span>
                                </div>
                                <div class="flex items-center justify-between text-base">
                                    <span class="text-[#585757] font-light">{{ __('noot-pro-content-management::site.discount_12_months') }}</span>
                                    <span class="text-(--primary-color) font-semibold">{{ __('noot-pro-content-management::site.discount_12_months_price') }}</span>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="{{ filament()->getRegistrationUrl() }}" class="block text-center px-6 py-3.5 w-full border-2 rounded-[14px] border-(--primary-color) bg-(--primary-color) hover:bg-(--secondary-color) hover:border-(--secondary-color) text-white transition ease-in-out">{{ __('noot-pro-content-management::site.get_the_package') }}</a>
                    </div>
                </div>
                <div class="xl:col-span-4 mb-6 xl:mb-0 col-span-full p-7 xl:p-14 bg-[#F7F7F7] rounded-[24px] xl:rounded-[48px] flex flex-col justify-between hover:shadow-2xl hover:bg-(--hover-bg-color) transition ease-in-out">
                    <div class="mb-10">
