<article class="mt-6 bg-gray-50 dark:bg-gray-800">
    <div class="px-6 pb-6 mx-auto rounded">
        <aside class="mt-2">
            <a href="{{ route('post',$post->slug) }}" class="text-xl md:text-3xl font-bold text-gray-700 dark:text-gray-200 hover:underline">
                {!! $post->title !!}
            </a>
