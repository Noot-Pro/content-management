    ...
    <div class="p-6 md:p-8 flex flex-col justify-between flex-grow relative bg-white z-20">
        <div>
            ...
            <a href="{{ route('post',$post->slug) }}" class="block">
                <h3 class="text-xl md:text-2xl font-extrabold text-gray-900 leading-tight group-hover:text-[#E86F44] transition-colors duration-300 line-clamp-2">
                    {!! $post->title !!}
                </h3>
            </a>
        ...
        <div class="flex items-center justify-between mt-6 md:mt-8 pt-6 border-t border-gray-50">
            <a href="{{ route('post',$post->slug) }}" class="inline-flex items-center text-sm font-bold text-[#E86F44] hover:text-[#EEAB43] transition-colors duration-300">
