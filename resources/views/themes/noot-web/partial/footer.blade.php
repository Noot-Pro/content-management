        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-12 gap-x-6 items-stretch">
                ...
                <div class="lg:col-span-6 xl:col-span-2 col-span-full mb-12 xl:mb-0">
                    ...
                    <ul>
                        <li class="mb-6"><a href="{{ url('page/about-as') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::site.about_us') }}</a></li>
                        <li class="mb-6"><a href="{{ url('page/privacy') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::site.privacy') }}</a></li>
                        <li class="mb-6"><a href="{{ url('page/term') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::site.term') }}</a></li>
                ...
                <div class="lg:col-span-12 xl:col-span-2 col-span-full">
                    ...
                    <ul class="mb-6">
                        <li class="mb-6"><a href="mailto:{{ config('noot.site.email') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ config('noot.site.email') }}</a></li>
                        <li class="mb-6"><a href="tel:{{ config('noot.site.phone') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ config('noot.site.phone') }}</a></li>
                    </ul>
                    <div>
