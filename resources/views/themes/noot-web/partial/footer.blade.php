            ...
            <div class="grid grid-cols-12 gap-x-6 items-stretch">
                <div class="lg:col-span-12 xl:col-span-4 col-span-full mb-12 xl:mb-0">
                    <div class="max-w-[300px]">
                        ...
                        <div>
                            <a href="{{ filament()->getRegistrationUrl() }}" class="inline-block px-6 py-3.5 border-2 rounded-xl border-(--primary-color) bg-(--primary-color) hover:bg-(--secondary-color) hover:border-(--secondary-color) text-white transition ease-in-out">{{ __('noot-pro-content-management::noot-web.start_free_test') }}</a>
                        </div>
                    </div>
                </div>
                <div class="lg:col-span-6 xl:col-span-2 col-span-full mb-12 xl:mb-0">
                    ...
                    <ul>
                        <li class="mb-6"><a href="{{ url('page/about-as') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::noot-web.about_us') }}</a></li>
                        <li class="mb-6"><a href="{{ url('page/privacy') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::noot-web.privacy') }}</a></li>
                        <li class="mb-6"><a href="{{ url('page/term') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::noot-web.term') }}</a></li>
                        <li class="mb-6"><a href="{{ url('faq') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ __('noot-pro-content-management::noot-web.faq') }}</a></li>
                    </ul>
                </div>
                <div class="lg:col-span-6 xl:col-span-2 col-span-full mb-12 xl:mb-0">
                ...
                <div class="lg:col-span-12 xl:col-span-2 col-span-full">
                    ...
                    <ul class="mb-6">
                        <li class="mb-6"><a href="mailto:{{ config('noot.noot-web.email') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ config('noot.noot-web.email') }}</a></li>
                        <li class="mb-6"><a href="tel:{{ config('noot.noot-web.phone') }}" class="text-white hover:text-(--primary-color) transition ease-in-out">{{ config('noot.noot-web.phone') }}</a></li>
                    </ul>
                    <div>
