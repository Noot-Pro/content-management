                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center shrink-0">
                        ...
                        {{-- Phone --}}
                        <div class="flex items-start gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div class="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center shrink-0">
                        ...
                        {{-- Address --}}
                        <div class="flex items-start gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div class="w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-lg flex items-center justify-center shrink-0">
                        ...
                        {{-- Working Hours --}}
                        <div class="flex items-start gap-4 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            <div class="w-12 h-12 bg-orange-100 dark:bg-orange-900 rounded-lg flex items-center justify-center shrink-0">
