    ...
    <section class="py-16 md:py-24 bg-white">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                {{-- Contact Form --}}
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">أرسل لنا رسالة</h2>
                    <p class="text-gray-600 mb-8">املأ النموذج أدناه وسنتواصل معك في أقرب وقت ممكن</p>
                    ...
                    <form wire:submit.prevent="submit" class="space-y-6">
                        ...
                        {{-- Subject --}}
                        <div>
                            <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">الموضوع <span class="text-red-500">*</span></label>
                            <input 
                                type="text" 
                                id="subject" 
                                wire:model="subject"
                        ...
                        {{-- Message --}}
                        <div>
                            <label for="message" class="block text-sm font-medium text-gray-700 mb-2">الرسالة <span class="text-red-500">*</span></label>
                            <textarea 
                                id="message" 
                                wire:model="message"
                                rows="6"
                ...
                {{-- Contact Information --}}
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">معلومات التواصل</h2>
                    <p class="text-gray-600 mb-8">يمكنك التواصل معنا عبر القنوات التالية</p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4 p-6 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <a href="mailto:info@noot.co" class="text-blue-600 hover:underline">info@noot.co</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-6 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 mb-1">رقم الهاتف</h3>
                                <a href="tel:+966555028398" class="text-blue-600 hover:underline">+966 55 502 8398</a>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-6 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 mb-1">ساعات العمل</h3>
                                <p class="text-gray-600">الأحد - الخميس: 9:00 ص - 5:00 م</p>
