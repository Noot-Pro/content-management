                    ...
                    <li>
                        <a href="{{ route('tags',['category',$tag->slug]) }}"
                           class="group flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                            <span class="font-medium text-sm text-gray-700 group-hover:text-[#E86F44] transition-colors">
                                {{ $tag->name }}
                            </span>
                            <div class="flex items-center text-gray-400 group-hover:text-[#E86F44] transition-colors gap-2">
                                <span class="bg-gray-100 text-gray-600 text-xs px-2.5 py-1 rounded-lg group-hover:bg-[#E86F44]/10 group-hover:text-[#E86F44] transition-colors font-semibold">{{ $tag->posts_published_count }}</span>
