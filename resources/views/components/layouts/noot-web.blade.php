    ...
    <style>
        ...
        * {font-family: 'Noto Kufi Arabic', sans-serif;}
        ...
        .links__item--has-dropdown > a:after {
            ...
            width: 16px;
            height: 16px;
            background: url("../../vendor/noot-pro/content-management/images/noot-web/arrow-down.svg") no-repeat center;
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-12 gap-x-6 items-stretch">
                ...
                <div class="lg:col-span-6 xl:col-span-2 col-span-full mb-12 xl:mb-0">
                    ...
                    <ul>
                        <li class="mb-6"><a href="{{ url('page/about-us') }}" class="text-white hover:text-[var(--primary-color)] transition ease-in-out">{{ __('noot-pro-content-management::noot-web.about_us') }}</a></li>
                        <li class="mb-6"><a href="{{ url('page/privacy') }}" class="text-white hover:text-[var(--primary-color)] transition ease-in-out">{{ __('noot-pro-content-management::noot-web.privacy') }}</a></li>
                        <li class="mb-6"><a href="{{ url('page/terms') }}" class="text-white hover:text-[var(--primary-color)] transition ease-in-out">{{ __('noot-pro-content-management::noot-web.terms') }}</a></li>
                        ...
                        <ul class="flex items-center">
                            <li class="me-4 relative transition ease-in-out hover:-translate-y-1">
                                <a target="_blank" href="https://x.com/bued_hr">
                                    <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/social-media/x.svg') }}" alt="">
                                </a>
                            </li>
                            <li class="me-4 relative transition ease-in-out hover:-translate-y-1">
                                <a target="_blank" href="https://www.tiktok.com/@bued.ai?_r=1&_t=ZS-91TJlartuml">
                                    <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/social-media/tiktok.svg') }}" alt="">
                                </a>
                            </li>
                            <li class="me-4 relative transition ease-in-out hover:-translate-y-1">
                                <a target="_blank" href="https://www.linkedin.com/in/%D9%86%D8%B8%D8%A7%D9%85-%D8%A8%D9%8F%D8%B9%D8%AF-%D9%84%D9%84%D9%85%D9%88%D8%A7%D8%B1%D8%AF-%D8%A7%D9%84%D8%A8%D8%B4%D8%B1%D9%8A%D8%A9-a97a84390/">
                                    <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/social-media/linkedin.svg') }}" alt="">
                                </a>
                            </li>
                            <li class="me-4 relative transition ease-in-out hover:-translate-y-1">
                                <a target="_blank" href="https://www.instagram.com/bued.hr/">
                                    <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/social-media/instagram.svg') }}" alt="">
                                </a>
                            </li>
                            <li class="me-4 relative transition ease-in-out hover:-translate-y-1">
                                <a target="_blank" href="https://www.snapchat.com/add/bued.ai?share_id=LT6hM6sFCME&locale=ar-SA">
                                    <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/social-media/snapchat.svg') }}" alt="">
                                </a>
                            </li>
                            <li class="relative transition ease-in-out hover:-translate-y-1">
                                <a target="_blank" href="https://www.facebook.com/profile.php?id=61583944401519">
                                    <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/social-media/facebook.svg') }}" alt="">
                                </a>
                            </li>
                        </ul>
                    </div>
                            ...
                            @if(app()->getLocale() === 'ar')
                                <li class="relative transition ease-in-out hover:-translate-y-1">
                                    <a target="_blank" href="https://play.google.com/store/apps/details?id=com.noot.app" >
                                        <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/googlePlay-ar.svg') }}" width="120px" alt="">
                                    </a>
                                </li>
                                <li class="relative transition ease-in-out hover:-translate-y-1 mx-1">
                                    <a target="_blank" href="https://apps.apple.com/gb/app/noot-%D9%86%D9%88%D8%AA/id6740081271?platform=iphone">
                                        <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/appStore-ar.svg') }}" width="110px" alt="">
                                    </a>
                                </li>
                            @else
                                <li class="relative transition ease-in-out hover:-translate-y-1">
                                    <a target="_blank" href="https://play.google.com/store/apps/details?id=com.noot.app">
                                        <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/googlePlay-en.svg') }}" width="120px" alt="">
                                    </a>
                                </li>
                                <li class="relative transition ease-in-out hover:-translate-y-1 mx-1">
                                    <a target="_blank" href="https://apps.apple.com/gb/app/noot-%D9%86%D9%88%D8%AA/id6740081271?platform=iphone" >
                                        <img src="{{ asset('vendor/noot-pro/content-management/images/noot-web/appStore-en.svg') }}" width="110px" alt="">
                                    </a>
                                </li>
                            @endif
                        </ul>
